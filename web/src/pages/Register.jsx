    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-dark-950 relative overflow-hidden px-4">
            ...
            <div className="w-full max-w-md glass-panel border border-slate-800/80 rounded-2xl p-8 shadow-2xl relative z-10 animate-fade-in">
                ...
                {/* Error Alert */}
                {errorMsg && (
                    <div className="mb-5 p-4 bg-rose-500/10 border border-rose-500/20 text-rose-400 rounded-xl text-sm font-medium animate-pulse-subtle">
                        {errorMsg}
                    </div>
                )}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="John"
                                    className="w-full pl-9 pr-3 py-2.5 bg-slate-900/60 border border-slate-800 focus:border-primary-500 rounded-xl text-slate-200 placeholder-slate-550 focus:outline-none transition-all text-sm"
                                />
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                minLength={8}
                                className="w-full pl-9 pr-9 py-2.5 bg-slate-900/60 border border-slate-800 focus:border-primary-500 rounded-xl text-slate-200 placeholder-slate-550 focus:outline-none transition-all text-sm"
                            />
                            <button
                                type="button"
